      ...
      <div className="flex flex-row items-end justify-between">
        ...
        <div className="flex flex-row items-center gap-4">
          ...
          <Link
            ...
            className="max-w-[200px] min-w-[175px] flex flex-row items-center gap-2 border-primary border-[3px] text-primary font-semibold p-2 rounded-md"
          >
            <FaPlus size={20} />
            Create Result
          </Link>

          <Button className="max-w-[200px] px-4 h-[44px] flex flex-row items-center gap-3 bg-primary text-white font-semibold p-[13px] rounded-md">
            <FiDownload size={24} />
            Download
          </Button>
        </div>
